...
namespace MateriaisParaConstrucao
{
    public partial class frmFuncionarios : Form
    {
        ...
        private void dtgFuncionarios_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                //Se houver linhas, a próxima verificação será para ver se a coluna btnEditar foi clicada.
                ...
                {
                    //Senão, verifica se o nome da coluna que recebeu o clique é btnExcluir e se o botão que foi clicado na caixa de mensagem é o Yes.
